...
- tmrt_stations.geojson (包含座標、線序、累積距離)

Usage:
    python scripts/build_tmrt_stations.py
"""
...
OUTPUT_DIR = Path(__file__).parent.parent / "public" / "data-tmrt" / "stations"


def build_tmrt_stations():
    """建立台中捷運車站 GeoJSON"""
    ...
    # 1. 讀取車站資料
    print("[1/3] 讀取車站資料...")
    with open(RAW_DIR / "tmrt_stations.json", 'r', encoding='utf-8') as f:
    ...
    # 寫入檔案
    output_path = OUTPUT_DIR / "tmrt_stations.geojson"
